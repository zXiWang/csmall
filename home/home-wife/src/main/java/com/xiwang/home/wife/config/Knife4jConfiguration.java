package com.xiwang.home.wife.config;
...
public class Knife4jConfiguration {
     ...
     * 【重要】指定Controller包路径
     */
    private final String basePackage = "com.xiwang.home.wife.controller";
    /**
     * 分组名称
     */
    private final String groupName = "base-wife";
    /**
     * 主机名
     */
     ...
     * 标题
     */
    private final String title = "酷鲨商城项目案例在线API文档--基础wife-web实例";
    /**
     * 简介
     */
    private final String description = "构建基础wife-web项目,实现购买";
    @Autowired
