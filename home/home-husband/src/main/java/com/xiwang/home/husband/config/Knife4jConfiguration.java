package com.xiwang.home.husband.config;
...
public class Knife4jConfiguration {
     ...
     * 【重要】指定Controller包路径
     */
    private final String basePackage = "com.xiwang.csmall.husband.controller";
    /**
     * 分组名称
     */
    private final String groupName = "base-husband";
    /**
     * 主机名
     */
     ...
     * 标题
     */
    private final String title = "酷鲨商城项目案例在线API文档--基础husband-web实例";
    /**
     * 简介
     */
    private final String description = "构建基础husband-web项目,实现购买";
    @Autowired
